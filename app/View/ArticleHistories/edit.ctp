<div class="row-fluid">
	<div class="span9">
		<?php echo $this->BootstrapForm->create('ArticleHistory', array('class' => 'form-horizontal'));?>
			<fieldset>
				<legend><?php echo __('Edit %s', __('Article History')); ?></legend>
				<?php
	...
	<div class="span3">
		...
		<ul class="nav nav-list">
			...
			<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ArticleHistory.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ArticleHistory.id'))); ?></li>
